...
public class MobileUtils {
    ...
    public void swipeScreen(Direction dir) throws MalformedURLException {
    ...
    public static void swipeScreenSmall(Direction dir) throws MalformedURLException {
    ...
    public static void scrollToElement(Direction direction, By by) throws MalformedURLException {
        int counter = 0;
        do {
    ...
    public static boolean isElementPresent(By by) throws MalformedURLException {
